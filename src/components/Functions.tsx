...
export default function Functions() {
  return (
    <section id="functions" className="functionSection">
      <svg
        width="100%"
        height="100%"
        id="svg"
      ...
      >
        <div className="functionCard">
          ...
          <div>
            ...
            <br />
            <p>
              Keep your server safe and organized. Kick, ban, mute users, clear
              chats, lock channels, or send warnings – all in one place.
            </p>
          </div>
        </div>
        ...
        <div className="functionCard">
          ...
          <div>
            ...
            <br />
            <p>
              Plan events or stay focused. Set personal reminders, start timers,
              check timezones, or create countdowns.
            </p>
          </div>
        </div>
        ...
        <div className="functionCard">
          ...
          <div>
            ...
            <br />
            <p>
              Organize your community. Create polls, manage suggestions, save
              notes, and track personal or shared to-do lists.
            </p>
          </div>
        </div>
        <div className="functionCard"></div>
        ...
        <div className="functionCard">
          ...
          <div>
            ...
            <br />
            <p>
              Useful commands for devs. Format JSON, encode/decode Base64,
              generate UUIDs, or check website response times and headers.
            </p>
          </div>
        </div>
        <div className="functionCard showMobile"></div>
        <div className="functionCard">
          ...
          <div>
            ...
            <br />
            <p>
              Handy features for gamers. Get Steam stats, Minecraft server info,
              Valorant ranks, or roll dice for TTRPGs.
            </p>
          </div>
        </div>
        <div className="functionCard"></div>
        ...
        <div className="functionCard">
          ...
          <div>
            ...
            <br />
            <p>
              All about the bot and users. View avatars, user and server info,
              measure latency, get bot stats, or grab the invite link.
            </p>
          </div>
        </div>
      </motion.div>
